...
public interface FavouriteRepository extends JpaRepository<Favourite, Long>{
    ...
    @Query(value = "SELECT fav_id FROM favourites WHERE user_id = ?1 AND car_park_id = ?2", nativeQuery = true)
    Optional<Long> findFavByUserIdAndCarParkId(Long id, String carparkId);
