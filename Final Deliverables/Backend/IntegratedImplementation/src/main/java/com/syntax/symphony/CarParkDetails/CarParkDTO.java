...
public class CarParkDTO {
    ...
    public CarParkDTO(CarPark cp) {
        this.carParkId = cp.getCarParkId();
        this.latitude = cp.getLatitude();
        this.longitude = cp.getLongitude();
        this.area = cp.getArea();
        this.development = cp.getDevelopment();
        this.availablelots = cp.getAvailablelots();
        this.lottypes = cp.getLottypes();
        this.agency = cp.getAgency();
    }
