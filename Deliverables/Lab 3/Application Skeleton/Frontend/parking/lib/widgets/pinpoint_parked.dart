            ...
            ElevatedButton(
              onPressed: () {
                if (_formKey.currentState!.validate()) {
                  _pinCon.processSubmission(_textEditingController.text);
                }
...
void checkGPS() async {
  ...
  if (serviceStatus) {
    ...
    if (permission == LocationPermission.denied) {
      ...
      if (permission == LocationPermission.denied) { print('Location permissions were denied'); }
      else if (permission == LocationPermission.deniedForever) { print('Location permission were denied permanently'); }
      else { hasPermission = true; }
    }
    else {hasPermission = true; }
  } 

  if (hasPermission) { print('GPS service permission granted'); } 
  else { print('GPS service permission denied'); }
}